...
/**
 * Precompiled convention.android-feature script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class ConventionAndroidFeaturePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ConventionAndroidFeature").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("convention.android-base");
            target.getPluginManager().apply("kotlin-parcelize");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ConventionAndroidFeature").asSubclass(BasicScript.class);
