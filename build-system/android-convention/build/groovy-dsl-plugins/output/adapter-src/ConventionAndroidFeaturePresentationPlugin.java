...
/**
 * Precompiled convention.android-feature-presentation script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class ConventionAndroidFeaturePresentationPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ConventionAndroidFeaturePresentation").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("convention.android-feature");
            target.getPluginManager().apply("org.jetbrains.kotlin.plugin.compose");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ConventionAndroidFeaturePresentation").asSubclass(BasicScript.class);
